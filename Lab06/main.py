...
# my regressor
regressor = my_regression.MyLinearMultivariateRegression()
regressor.fit(x[input_labels[0]], x[input_labels[1]], y)
...
# mine 
df_validate['predicted'] = regressor.predict(df_validate[input_labels[0]], df_validate[input_labels[1]])
