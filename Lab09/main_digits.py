...
#train with tool
classifier = neural_network.MLPClassifier(hidden_layer_sizes=(5, ), activation='relu', max_iter=200, solver='sgd', verbose=True, random_state=1, learning_rate_init=.1)
...
plot.plotConfusionMatrix(cm, target_names, "digit classification")
